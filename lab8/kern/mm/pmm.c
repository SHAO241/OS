...
switch_kernel_memorylayout()
{
    ...
    if (((uintptr_t)bootstackguard + PGSIZE == (uintptr_t)bootstack) && 
    ((uintptr_t)bootstacktop == (uintptr_t)boot_page_table_sv39)) 
    {
        ...
        // 2. 增加 (uintptr_t) 强转以修复 "makes integer from pointer" 错误
